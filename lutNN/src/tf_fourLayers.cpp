...
int main(void) {
    ...
    unsigned int neuronCntL2 = 5; //superlayer
    ...
    layersDef.emplace_back(ConfigParametersPtr(new ConfigParameters(neuronCntL1 * neuronCntL2, lutSize, lutSize, 2,        ConfigParameters::fullyConnected) ) );
    layersDef.emplace_back(ConfigParametersPtr(new ConfigParameters(neuronCntL1,               lutSize, lutSize, neuronCntL2, ConfigParameters::fullyConnected) ) );
 ...
 /*   for(unsigned int iLayer = 0; iLayer < layersDef.size(); iLayer++ ) {
    ...
    unsigned int batchSize = 100000; //TODO
    ...
    int mode = 0;
    int iterations = 100; //TODO
    int printEveryIteration = 1; //TODO
    bool stochastic = false; //TODO
    ...
    for(int i = 0; i < iterations; i++) {
       ...
       /* if(i == 0) { //not sure if needed
        ...
        if(i == 0) { //not sure if needed
            learnigParamsVec[0].learnigRate = 80;//0.5;//0.5;//2.;
            learnigParamsVec[0].regularizationRate = 0;// * learnigParams.learnigRate;

            learnigParamsVec[1].learnigRate = 100;//0.5;//2.;
            learnigParamsVec[1].regularizationRate = 0;// * learnigParams.learnigRate;

            learnigParamsVec[2].learnigRate = 80;//0.4;//0.5;//2.;
            learnigParamsVec[2].regularizationRate = 1;// * learnigParams.learnigRate;

            learnigParamsVec[3].learnigRate = 0.002 ;
            learnigParamsVec[3].regularizationRate = 1;//0.1;// * learnigParams.learnigRate;
        }
