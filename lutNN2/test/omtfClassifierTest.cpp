...
/*    std::vector<EventFloat*> events;
    ...
    ClassifierToRegressionPSum classifierToRegressionPSum07(ptBins, 0.7);
    PtCalibration ptCalibrationPSumInter07("ptCalibrationPSumInter07");
    ptCalibrationPSumInter07.train(events, classifierToRegressionPSum07, 0);
...
*/
    ...
    omtfAnalyzer.muonAlgorithms.emplace_back(new LutNNClassifierCalibrated(19, 0, "NN_PSumInter_05_calib", kRed, ptBins, classifierToRegressionPSum05, &ptCalibrationPSumInter05) );
    omtfAnalyzer.muonAlgorithms.back()->algosToCompare.push_back(omtfAlgo);

    omtfAnalyzer.muonAlgorithms.emplace_back(new LutNNClassifierCalibrated(20, 0, "NN_PSumInter_05_calib", kRed, ptBins, classifierToRegressionPSum05, &ptCalibrationPSumInter05) );
    omtfAnalyzer.muonAlgorithms.back()->algosToCompare.push_back(omtfAlgo);
    ...
    omtfAnalyzer.muonAlgorithms.emplace_back(new LutNNClassifierCalibrated(23, 0, "NN_PSumInter_05_calib", kRed, ptBins, classifierToRegressionPSum05, &ptCalibrationPSumInter05) );
    omtfAnalyzer.muonAlgorithms.back()->algosToCompare.push_back(omtfAlgo);

    omtfAnalyzer.muonAlgorithms.emplace_back(new LutNNClassifierCalibrated(25, 0, "NN_PSumInter_05_calib", kRed, ptBins, classifierToRegressionPSum05, &ptCalibrationPSumInter05) );
    omtfAnalyzer.muonAlgorithms.back()->algosToCompare.push_back(omtfAlgo);
    ...
    omtfAnalyzer.muonAlgorithms.emplace_back(new LutNNClassifierCalibrated(8, 0, "NN_PSumInter_05_calib", kRed, ptBins, classifierToRegressionPSum05, &ptCalibrationPSumInter05) );
    omtfAnalyzer.muonAlgorithms.back()->algosToCompare.push_back(omtfAlgo);

    omtfAnalyzer.muonAlgorithms.emplace_back(new LutNNClassifierCalibrated(10, 0, "NN_PSumInter_05_calib", kRed, ptBins, classifierToRegressionPSum05, &ptCalibrationPSumInter05) );
    omtfAnalyzer.muonAlgorithms.back()->algosToCompare.push_back(omtfAlgo);



    omtfAlgo = omtfAnalyzer.muonAlgorithms[3].get(); //20
    omtfAnalyzer.muonAlgorithms.emplace_back(new LutNNClassifierCalibrated(17, 0, "NN_PSumInter_07", kRed, ptBins, classifierToRegressionPSum07));
    omtfAnalyzer.muonAlgorithms.back()->algosToCompare.push_back(omtfAlgo);

    omtfAnalyzer.muonAlgorithms.emplace_back(new LutNNClassifierCalibrated(18, 0, "NN_PSumInter_07", kRed, ptBins, classifierToRegressionPSum07));
    omtfAnalyzer.muonAlgorithms.back()->algosToCompare.push_back(omtfAlgo);

    omtfAnalyzer.muonAlgorithms.emplace_back(new LutNNClassifierCalibrated(20, 0, "NN_PSumInter_07", kRed, ptBins, classifierToRegressionPSum07));
    omtfAnalyzer.muonAlgorithms.back()->algosToCompare.push_back(omtfAlgo);

    omtfAnalyzer.muonAlgorithms.emplace_back(new LutNNClassifierCalibrated(18, 0, "NN_PSumInter_07_calib", kRed, ptBins, classifierToRegressionPSum07, &ptCalibrationPSumInter07) );
    omtfAnalyzer.muonAlgorithms.back()->algosToCompare.push_back(omtfAlgo);

    omtfAnalyzer.muonAlgorithms.emplace_back(new LutNNClassifierCalibrated(20, 0, "NN_PSumInter_07_calib", kRed, ptBins, classifierToRegressionPSum07, &ptCalibrationPSumInter07) );
    omtfAnalyzer.muonAlgorithms.back()->algosToCompare.push_back(omtfAlgo);
